...
static const char __pyx_k_Users_lywen_Desktop_ocrmodel_gi[] = "/Users/lywen/Desktop/ocrmodel/git/new-text-detection-ctpn/lib/utils/gpu_nms.pyx";
 ...
 */
  ...
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(3, 0, 10, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_lywen_Desktop_ocrmodel_gi, __pyx_n_s_gpu_nms, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
